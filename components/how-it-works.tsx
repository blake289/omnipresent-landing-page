...
const steps = [
  {
    ...
    body: "Tell us about your business and where leads are falling through. We\u0027ll map out exactly what we\u0027d build. If it\u0027s not a fit, we\u0027ll say so.",
  },
  {
    num: 2,
    title: "Your new site goes live in 48 hours",
    body: "Custom design, real copywriting, optimized for speed and mobile. This is a $3K–$5K+ website built at no cost. You review everything before launch.",
  },
  {
    num: 3,
    title: "Leads start coming in",
    body: "Missed-call text-back goes live day one. Lead capture is active. Follow-up sequences are running. You see every lead on your dashboard.",
  },
]
      ...
      <div ref={ref} className="max-w-[680px] mx-auto px-6 max-sm:px-5">
        ...
        <div className="mt-7">
          {steps.map((step, i) => (
            <div
              key={step.num}
              className={`flex gap-[18px] mb-8 last:mb-0 transition-all duration-700 ${isVisible
        ...
        <div
          className={`text-center mt-9 transition-all duration-700 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-5"
            }`}
          style={{ transitionDelay: "400ms" }}
        >
          <a
            href="#book"
            data-track="how_it_works_cta"
